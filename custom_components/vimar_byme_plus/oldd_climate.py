...
from xknx.devices import Climate, ClimateMode, ClimateMode as ClimateMode
...
class VimarClimate(KnxEntity, ClimateEntity):
...
def _create_climate(xknx: XKNX, config: ConfigType) -> Climate:
