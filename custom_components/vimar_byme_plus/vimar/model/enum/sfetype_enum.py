...
class SfeType(Enum):
    ...
    STATE_SENSOR_TEMPERATURE_MIN = "SFE_State_SensorTemperatureMin"
    STATE_SENSOR_TEMPERATURE_MAX = "SFE_State_SensorTemperatureMax"
    STATE_ABSOLUTE_SENSOR_TEMPERATURE_MIN = "SFE_State_AbsoluteSensorTemperatureMin"
    STATE_ABSOLUTE_SENSOR_TEMPERATURE_MAX = "SFE_State_AbsoluteSensorTemperatureMax"
    STATE_WIND_SPEED = "SFE_State_WindSpeed"
    STATE_WIND_SPEED_MAX = "SFE_State_WindSpeedMax"
    STATE_ABSOLUTE_WIND_SPEED_MAX = "SFE_State_AbsoluteWindSpeedMax"
    STATE_BRIGHTNESS_OUTPUT_1 = "SFE_State_BrightnessOutput1"
