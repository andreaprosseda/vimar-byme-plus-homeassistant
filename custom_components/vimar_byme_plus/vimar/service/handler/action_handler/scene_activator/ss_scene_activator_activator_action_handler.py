...
EXECUTE = SfeType.CMD_DOWNKEY_ACTIVE_SCENE


class SsSceneActivatorActivatorActionHandler(BaseActionHandler):
    ...
    def get_press_actions(self, component: VimarButton) -> list[VimarAction]:
        return [self._action(component.id, EXECUTE, "Execute")]
